...
function obtenerAnuncio(frm, tieneId) {
    ...
    return new Mascota(id, titulo, transaccion,descripcion, precio,animal, raza, fecha, vacuna);
}
...
function setValues(e) {
    ...
    document.getElementById("raza").value = nodos[5].innerText;
    document.getElementById("fecha").value = nodos[6].innerText;
    document.getElementById("vacuna").value = nodos[7].innerText;
    if (nodos[2].innerText === "Perro") {
...
function limpiarValues() {
    ...
    document.getElementById("vacuna").value = 0;
